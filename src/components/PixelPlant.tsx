  ...
  return (
    <View style={[styles.container, { width: size, height: size }, style]}>
      <Svg width="100%" height="100%" viewBox="0 0 500 500">
        ...
        <AnimatedG origin={LEAVES.left.origin} transform={[{ translateX: leftTX }, { translateY: leftTY }]}>
          <Path
        ...
        <AnimatedG origin={LEAVES.center.origin} transform={[{ translateX: centerTX }, { translateY: centerTY }]}>
          <Path
        ...
        <AnimatedG origin={LEAVES.right.origin} transform={[{ translateX: rightTX }, { translateY: rightTY }]}>
          <Path
